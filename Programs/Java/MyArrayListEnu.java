...
class MyArrayListEnu extends TestArrayList {

   ArrayList<String> al = null ;

   public MyArrayListEnu() {

      al = new ArrayList<String>() ;

   } 

   public MyArrayListEnu(int initCapacity) {

      al = new ArrayList<String>(initCapacity) ;
   }   
...
*/
   ...
   public static void main( String[] args ) {
       ...
       new MyArrayListEnu().processChoice() ;
   }
